...
def main():
    ...
    for track in spotify_tracks:
        ...
        # TODO determine if and when rate limiting occurs for hitting the search endpoint. Handle as needed.
        # the limit parameter of the search function does not seem to work so slice the response
    ...
    # TODO determine what the max number of video_ids you can send to create/playlist endpoint at once.
